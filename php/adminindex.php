...
<html>
    ...
    <body bgcolor="#E6E6FA">
        ...
        <div><marquee behavior="alternate" direction="right" style="margin-top: -49px;font-size:20px;font-size:30px;margin-bottom:10px;"><b>Best Online Offers<b></marquee>
        <marquee behavior="alternate" direction="left" style="margin-top: -49px;font-size:30px;"><b>Get Discount upto 50%<b></marquee>
        </div>
        <!-- <img class="promoimg" src="../images/promo.jpg" alt=""> -->

        <div class="adminpanel">
        <h2 class="center" ><b>Admin Panel<b></h2>
        ...
        <a href='viewproduct.php'><button class="left">View /Update Product</button></a>
        <center> <a href='reportmenu.php'><button class="left">Reports</button></a> </center>

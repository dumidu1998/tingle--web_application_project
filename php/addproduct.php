...
<html>
	...
	<body>
	<a href="viewproduct.php"><button type="button" class="viewbutton">View</button></a>
		<div class="loginbox">
...
<?php
	...
	$sql = "INSERT INTO item(itemId,iName,SID,iCategory,iSubcategory,iPrice,qtyOnHand,description) values ('".$_POST['pid']."','".$_POST['pname']."','".$_POST['sid']."','".$_POST['category']."','".$_POST['subcategory']."','".$_POST['pprice']."','".$_POST['qty']."','".$_POST['desc']."')";

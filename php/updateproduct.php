...
<?php
	...
	$sql2 = "UPDATE item SET itemId  ='".$_POST['iid']."', iName  ='".$_POST['iname']."', SID  ='".$_POST['sid']."', iCategory ='".$_POST['icat']."', iSubcategory ='".$_POST['iscat']."',iPrice ='".$_POST['iprice']."',qtyOnHand ='".$_POST['qty']."',description='".$_POST['desc']."' WHERE itemId  ='".$_POST['iid']."'";   
	$result2 = mysqli_query($connection,$sql2);

	$sql3 = "SELECT * FROM item WHERE itemId ='".$_POST['iid']."'";
...
<body>
	<div class="center"><p><h1>Update Product Details</h1></p><br /></div>
	<table align="center">
		<tr>
			<td>itemId </td>
			<td>iName </td>
		...
		<form action='updateproduct.php' method ='post'>
			...
			echo "<td><textarea name='desc' rows='4' cols='50' placeholder =''>".$row['description']."</textarea></td>";
			?>
		</tr>
		<tr>
			<td colspan =3><a href="viewproduct.php"><button type="button" class="addbutton">View All</button></a></td>
			<td colspan =3><input type='submit' class="addbutton" value="Update" name='updateB'></td>			
		</tr>
		</form>
	</table>
</body>

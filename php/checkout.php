...
<html>
    ...
    <body>
        ...
        <br>
            ...
            <input type="number" name="exmo" placeholder="MM" class="cdatem" min="1" max="12"><b style="font-size:25px"> /</b>
            <input type="number" name="exyr" placeholder="YYYY" class="cdatey" min="2020" >
            <br>
            <br>
        </div>

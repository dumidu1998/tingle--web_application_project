...
<html>
	...
	<body>
	<a href="login.php"><input type="button" class="loginbutton" value="Login"></a>
		<div class="loginbox">
			<h1>Sign Up</h1>
			<form method="POST" action="signup.php" name="form1">
				...
				<input type="submit" class=button name="submit" value="Sign Up" onsubmit="return checktel(document.form1.usertelephone)" ><input type="reset" class=button name="reset" value="Cancel">
